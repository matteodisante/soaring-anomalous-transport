...
def main() -> None:
    ...
    result = {"verified_utc": datetime.now(UTC).isoformat(),
              ...
              "visual_review": "Chapter 3 slide 42 explains component-versus-radial density shape with a strip/disk diagram and regular-density conditions. Slide 49 explicitly acknowledges approximate east/north collapse and reports the unchanged ECDF distances and process-self-similarity limits. These additions and their notes were checked for readable formulas and agreement with thesis pages 65--66. The reviewed component-scaling, quantile-fitting and Hurst-limit slides retain their content. Wind slides are now 79--83; their figures and numerical content are unchanged. Values, support and group definitions agree with the complete reviewed reports."}
