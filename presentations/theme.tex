...
\setbeamertemplate{footline}{%
  \hspace{7mm}\textcolor{muted}{\fontsize{6.5}{8}\selectfont
    Matteo Di Sante\enspace|\enspace\TalkShort\enspace|\enspace11 September 2026}
...
\newcommand{\timing}[2]{\note{\textbf{Time: #1.}\par\medskip #2}}
...
% destinations; the normal talk PDF retains all hyperlinks and the viewer button.
