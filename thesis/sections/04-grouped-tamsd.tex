...
circuit class, altitude band and segment control, an unweighted least-squares fit in
...
\begin{figure}[p]
 ...
 Columns distinguish the declared circuit classes; the
...
\begin{table}[htbp]
 ...
 Brackets give marginal 95\% site--day bootstrap intervals. Flight counts show
 available support at 10 and 10,000~s; the fixed control retains the latter
 flight set throughout. Weighting and controls match Fig.~\ref{fig:altitude-hurst}.}
...
altitude comparison from the mixture of declared task types. With available
segments, open circuits have larger fitted exponents than closed circuits in
each altitude band. The altitude ordering also changes with circuit class:
Plains and Hills lie above both mountain-labelled groups for open circuits,
whereas both mountain-labelled groups lie above Plains and Hills for closed
circuits. Flight support
differs substantially between strata. In particular, the fixed closed-circuit
Plains control contains only
...
should be read alongside this small population. The fixed controls condition
on long continuous records; they do not match the open and closed groups by
duration, region, weather or pilot. Differences between their fitted exponents
can therefore reflect both route geometry and population composition.
