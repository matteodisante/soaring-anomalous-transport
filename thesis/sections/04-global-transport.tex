...
which is what a correlated Gaussian motion looks like.
...
\paragraph{How long a heading survives.}
...
there. The heading memory of a soaring wing is shorter than the scale at which this dataset
can speak, so what is reported is a lower bound on the decay and not the decay.
