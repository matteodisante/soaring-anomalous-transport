...
how many regimes each curve really holds is left open here; it is what
Chapter~\ref{ch:next-steps} takes up with an estimator built for it. The time-averaged
values are
