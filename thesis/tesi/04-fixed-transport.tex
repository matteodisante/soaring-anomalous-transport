...
\input{generated/ch3_conditional_circuit_weights_values}
...
\begin{itemize}
 \item \emph{Circuit type}: open distance flights versus closed routes.
...
Testing the role of triangular geometry requires separating the two closed
route types and comparing their actual leg durations.
