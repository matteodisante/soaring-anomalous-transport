...
Confirming the fallback also holds there would need the same presence statistic computed
on the GNSS channel, which this scan does not carry. Whatever that comparison would show,
