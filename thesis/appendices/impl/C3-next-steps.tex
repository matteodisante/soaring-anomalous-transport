...
\path{soaring.analysis.transport} and the figure, the curve table and the
...
\path{soaring.analysis.transport.local_slope} therefore works on a window: at each lag it
