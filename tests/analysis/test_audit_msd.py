...
``scripts/condivisi/audit_msd.py`` deliberately duplicates
...
def audit():
    return _load("audit_msd", "scripts/condivisi/audit_msd.py")


@pytest.fixture(scope="module")
def report():
    return _load("audit_msd_report", "scripts/tesi/ch02_dataset/audit_msd_report.py")
