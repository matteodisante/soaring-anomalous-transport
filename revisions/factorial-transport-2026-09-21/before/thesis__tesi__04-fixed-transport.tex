...
The metadata allow many further combinations: experts and beginners could be
compared separately on open and closed circuits, then within each altitude class,
region or season. The same construction extends to other recorded attributes,
provided each intersection retains enough flights. Here we concentrate on
orography and circuit type, together with the equipment proxy for experience;
the comparisons below do not exhaust those possible combinations.
...
terrain crossed later. We first compare the four classes directly, setting circuit
type aside. All circuit declarations, including unclassified ones, contribute to
