...
def excess_kurtosis(values, owners, sizes, counts):
    ...
    computed once with :func:`numpy.bincount` (not :func:`numpy.add.at`, which scatter-adds
    the whole matrix and costs seconds rather than milliseconds here) and reused across
    all draws by one matrix product.
