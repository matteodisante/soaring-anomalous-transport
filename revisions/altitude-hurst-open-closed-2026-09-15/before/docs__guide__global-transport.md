...
Section 3.4.4 additionally fits the altitude-band curves over all 59 lags from
10 to 10000 s. Figure 3.20 and Table 3.9 report H_eff = slope/2 with marginal
95% intervals from 2000 whole-site-day bootstrap draws, separately for available
and fixed long segments. These describe effective moment scaling conditional on
the fit range and population. The `altitude_hurst` rebuild stage exports the
...
`revisions/altitude-hurst-thesis-2026-09-15/`.
