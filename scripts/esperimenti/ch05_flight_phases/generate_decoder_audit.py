...
def main(argv: list[str] | None = None) -> int:
    ...
    coverages = {}
    table = [
        r"% Generated by scripts/esperimenti/ch05_flight_phases/"
    ...
    values = [
        "% Generated by scripts/esperimenti/ch05_flight_phases/generate_decoder_audit.py; match the audited snapshot."
    ]
