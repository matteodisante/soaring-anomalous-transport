...
#
#   scripts/pipeline/build_docs.sh stats      # regenerate acquisition statistics only
#   scripts/pipeline/build_docs.sh thesis     # compile existing thesis inputs (default)
#   scripts/pipeline/build_docs.sh clean      # remove LaTeX aux files
#
...
gen_stats() { python3 scripts/tesi/ch02_dataset/generate_stats.py; }
