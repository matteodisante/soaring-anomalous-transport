...
def main(argv=None):
    ...
    lines = [
        ...
        "from the mounted disk by `scripts/tools/write_ssd_readme.py`.",
        "",
    ...
    lines += [
        ...
        "The complete sequence is `uv run python scripts/pipeline/rebuild_thesis.py --clean --jobs 8 --full-speed`.",
        "",
